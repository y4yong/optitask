    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-8">
            ...
            <div class="glass-card p-8">
                <h3 class="font-extrabold text-[#1e293b] text-xl mb-8 flex items-center gap-3">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="flex flex-col items-center">
                        <h4 class="text-xs font-black uppercase text-pink-400 tracking-wider mb-4">Task Status Distribution</h4>
                    ...
                    <div class="flex flex-col items-center">
                        <h4 class="text-xs font-black uppercase text-pink-400 tracking-wider mb-4">Department Productivity</h4>
        ...
        <!-- Sidebar Timeline & User Directory Mix -->
        <div class="space-y-8">
            <!-- Live Audit Timeline -->
            <div class="glass-card p-8 flex flex-col h-full">
                ...
                <div class="space-y-6 relative border-l-2 border-pink-100 ml-2 pl-6 overflow-y-auto max-h-[400px] pr-2">
                    <?php if (empty($recent_logs)): ?>
                        <p class="text-xs text-gray-400 font-bold italic">No system activity detected.</p>
                    <?php else: ?>
                        <?php foreach($recent_logs as $log): ?>
                            ...
                            <div class="relative">
                                ...
                                <p class="text-[10px] text-gray-500 font-medium mt-1 leading-relaxed"><?= htmlspecialchars($log['details']) ?></p>
                                <div class="flex items-center gap-2 mt-2">
                                    <span class="text-[9px] bg-pink-50 text-pink-500 px-2 py-0.5 rounded-md font-bold uppercase tracking-wider"><?= htmlspecialchars($log['username'] ?? 'System') ?></span>
                                    <span class="text-[9px] text-gray-400 font-mono"><?= date('h:i A', strtotime($log['timestamp'])) ?></span>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    <?php endif; ?>
                </div>
                <div class="mt-6 pt-6 border-t border-pink-50 text-center">
