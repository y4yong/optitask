...
<div id="modalBackdrop" class="modal-backdrop fixed inset-0 z-50 items-center justify-center p-6">
    <div class="w-full max-w-2xl bg-white rounded-[3rem] shadow-2xl overflow-hidden border border-pink-50">
        ...
        <div class="p-10 space-y-8 bg-white">
            ...
            <!-- Manager Attached File -->
            <div id="mFileContainer" class="bg-white rounded-[2rem] p-6 border border-pink-100 flex items-center justify-between shadow-sm hidden">
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 rounded-xl bg-pink-50 text-[#FB6F92] flex items-center justify-center">
                        <i data-lucide="paperclip" class="w-5 h-5"></i>
                    </div>
                    <div>
                        <p class="text-[10px] font-black text-pink-400 uppercase tracking-widest">Manager Attachment</p>
                        <p id="mFileName" class="text-xs font-extrabold text-[#1e293b] truncate max-w-xs"></p>
                    </div>
                </div>
                <a id="mFileLink" href="#" download class="px-5 py-2.5 bg-pink-50 hover:bg-pink-100 text-[#FB6F92] text-xs font-black uppercase rounded-xl transition-all flex items-center gap-1.5 shadow-sm">
...
<script>
    ...
    function openModal(t) {
        ...
        // Handle Manager Task Attachment File
