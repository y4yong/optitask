...
@section('title', 'OptiTask | Manager Notifications')

@section('content')
    <header class="flex justify-between items-end mb-10">
        <div>
            <h1 class="text-4xl font-extrabold text-[#1e293b] tracking-tight uppercase">Notifications</h1>
            <p class="text-pink-400 mt-1 font-bold">Approvals, submissions, and team capacity alerts.</p>
        </div>
                            ...
                            <div class="flex-1">
                                ...
                                @if ($n->notification_type === 'Submission')
                                    <div class="mt-4 flex gap-3">
                                        <a href="{{ route('manager.verify_tasks') }}" class="px-5 py-2 rounded-xl text-[11px] font-black pink-gradient text-white shadow-md shadow-pink-100 inline-block uppercase">REVIEW NOW</a>
                                    </div>
                                @endif
        ...
        <div class="space-y-8">
            <div class="glass-card p-10 relative overflow-hidden bg-white">
                ...
                <div class="space-y-4 relative">
                    <a href="{{ route('manager.assign_tasks') }}" class="w-full p-5 bg-[#FF8FAB] hover:bg-[#FB6F92] text-white rounded-2xl text-[11px] font-black uppercase tracking-widest flex items-center gap-3 shadow-lg hover:scale-[1.02] transition-all duration-300">
                        <i data-lucide="plus-circle" class="w-5 h-5 text-pink-500"></i> Assign New Work
                    </a>
                    
                    <a href="{{ route('manager.verify_tasks') }}" class="w-full p-5 bg-white border-2 border-pink-50 text-[#1e293b] rounded-2xl text-[11px] font-black uppercase tracking-widest flex items-center gap-3 hover:border-[#FB6F92] hover:text-[#FB6F92] hover:bg-pink-50/50 transition-all">
